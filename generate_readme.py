...
ALL_CONFIGS_FILE = config['paths']['merged_configs'] # This is now generated by create_rotating_sub
...
<!-- The merged_configs.txt file is no longer the primary link. You can decide to generate it if needed. -->
<!-- 
